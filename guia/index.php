...
class Xlsx
{
    ...
    // public function CrearXlsx($opt, $sql)   SIERVEEEE
    // {
    //     switch ($opt) {
    //         case 'sql':
    //             $sql = $this->CNX2->prepare($sql);
    ...
    //         // Verifica la longitud de cada valor en la fila del encabezado
    //         foreach ($headerRow->getCells() as $cell) {
    //             $cellValue = $cell->getValue();
    //             if (mb_strlen($cellValue, 'UTF-8') > 32767) {
    //                 // Trunca el valor si supera el límite
    //                 $cell->setValue(mb_substr($cellValue, 0, 32767, 'UTF-8'));
    //             }
    //         }
    ...
    //             // Verifica la longitud de cada valor en la fila de datos
